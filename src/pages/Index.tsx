      ...
      <Hero image={heroForest}>
        <div className="flex flex-col items-center justify-center text-center gap-6 sm:gap-8 animate-fade-in-up pt-4 sm:pt-8">
          ...
          <div className="flex flex-col items-center gap-2 sm:gap-3">
            <div className="flex items-center gap-3 text-soft-white text-4xl sm:text-5xl font-semibold">
              <Calendar className="w-10 h-10" />
              <span className="font-playfair">13 juin 2026</span>
            </div>
            <p className="font-inter text-2xl sm:text-3xl text-soft-white/90 mt-2">
          ...
          <div className="mt-4 flex flex-col items-center gap-3 w-full max-w-sm">
            ...
            >
              Dress Code
              <ChevronDown
                className={`w-7 h-7 transition-transform duration-300 ${dressCodeOpen ? "rotate-180" : ""}`}
              />
            </button>

            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out w-full ${
                dressCodeOpen ? "max-h-[700px] opacity-100" : "max-h-0 opacity-0"
              }`}
            >
      ...
      <section id="infos" className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="font-fiancee text-8xl sm:text-9xl font-normal text-foreground mb-4">
              Infos pratiques
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card p-8 rounded-xl shadow-soft border border-border/50 space-y-4">
              <div className="flex items-center gap-3 text-accent mb-4">
                ...
                <h3 className="font-playfair text-3xl font-semibold text-foreground">Lieu</h3>
              </div>
              <a
            ...
            <div className="bg-card p-8 rounded-xl shadow-soft border border-border/50 space-y-4">
              <div className="flex items-center gap-3 text-accent mb-4">
                ...
                <h3 className="font-playfair text-3xl font-semibold text-foreground">Programme</h3>
              </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-soft border border-border/50 space-y-4">
              <div className="flex items-center gap-3 text-accent mb-4">
                ...
                <h3 className="font-playfair text-3xl font-semibold text-foreground">Hébergement</h3>
              </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-soft border border-border/50 space-y-4">
              <div className="flex items-center gap-3 text-accent mb-4">
                ...
                <h3 className="font-playfair text-3xl font-semibold text-foreground">Note importante</h3>
              </div>
              <p className="text-muted-foreground italic text-2xl">
