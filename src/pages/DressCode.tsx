  ...
  return (
    <div className="min-h-screen bg-background font-savoye">
      ...
      <Hero image={heroForest}>
        <div className="flex flex-col items-center justify-center text-center gap-4 sm:gap-6 animate-fade-in-up pt-2 sm:pt-4">
          <h1 className="font-savoye text-6xl sm:text-8xl font-normal text-soft-white drop-shadow-lg">
            Dress Code
          </h1>
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl px-6 sm:px-8 py-4 sm:py-6 max-w-2xl w-full border border-soft-white/20 space-y-4 text-center">
            <p className="font-savoye text-2xl sm:text-4xl text-soft-white leading-relaxed">
